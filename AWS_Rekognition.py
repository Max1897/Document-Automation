...
def classifier_reko(image):
    ...
    try:
        ...
        model = 'arn:aws:rekognition:us-east-2:533267089859:project/classifier/version/classifier.2024-05-24T03.44.30/1716536669975'
        ...
        # Analyze local image.
        label_name = analyze_local_image(rekognition_client,
                                            model,
                                            image,
                                            min_confidence)
