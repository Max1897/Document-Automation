...
# https://learn.microsoft.com/en-us/azure/ai-services/document-intelligence/quickstarts/
# get-started-sdks-rest-api?view=doc-intel-4.0.0&pivots=programming-language-python
...
key = "0593534c55624a1e9c10a218d2ea92c0"
endpoint = "https://wpp-azure.cognitiveservices.azure.com/"

def analyze_invoice():
    # sample document

    # invoiceUrl = "https://online.publuu.com/587654/1318528"
    ...
    #     "prebuilt-tax.us.W-2", AnalyzeDocumentRequest(url_source=invoiceUrl)
    # )
    # invoices = poller.result()

    file_name ='raw data\Script\W2_XL_input_clean_1000.pdf'
    ...
    poller = document_intelligence_client.begin_analyze_document(
        "prebuilt-tax.us.W-2", bytes_test
    )
